    ...
    >
      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        <input
          type="text"
          {...register("name")}
          className={`px-3 py-2 rounded-md border focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-300 placeholder:text-gray-400 ${errors.name ? "border-red-500" : "border-gray-300"}`}
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          <input
            ...
            className={`px-3 py-2 rounded-md border focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-300 placeholder:text-gray-400 w-full pr-10 ${errors.confirmPassword ? "border-red-500" : "border-gray-300"}`}
            placeholder="********"
          />
          <button
            type="button"
